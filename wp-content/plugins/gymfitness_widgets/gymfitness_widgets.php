...
/*
        ...
        Plugin URI:
        Description:Adds a Costum Widget in the WordPress Pane;
        Version:1.0
        Author: Besmir Gashi
        Author URI:
...
class GymFitness_Classes_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            array('description' => esc_html__('Displays different classes in the widgets', 'text_domain'),) // Args
        );
    }
...
// register GymFitness_Classes_Widget widget
